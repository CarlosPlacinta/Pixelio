...
**Latest version: [1.3.26](https://github.com/CarlosPlacinta/Pixelio/releases/tag/v1.3.26)** · **[Full changelog](CHANGELOG.md)**

## Install

Download **Pixelio-Setup-1.3.26-x64.exe** from the
...
- Wired and its integrated Watch & Walk use only the selected account's built-in Pixelio engine. Manual/advanced connection controls and port fields are removed. Watch & Walk follows account changes and reconnects disarmed.
