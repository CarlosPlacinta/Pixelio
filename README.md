...
**Latest version: [1.2.14](https://github.com/CarlosPlacinta/Pixelio/releases/tag/v1.2.14)** · **[Full changelog](CHANGELOG.md)**

## Install

Download **Pixelio-Setup-1.2.14-x64.exe** from the
...
- Integrated window controls in a taller navigation header, with more breathing room around the Pixelio logo.
- Aligned minimize, maximize/restore and close icons, adaptive spacing and a matching Windows 11 frame colour.
...
Existing versions with the updater can receive 1.2.14 when they next open.
...
**Versão atual: [1.2.14](https://github.com/CarlosPlacinta/Pixelio/releases/tag/v1.2.14)** · **[Histórico completo](CHANGELOG.md)**

Baixe **Pixelio-Setup-1.2.14-x64.exe** na
...
A versão 1.2.14 integra os controles da janela ao cabeçalho, com mais altura, espaço ao redor do logo e ícones alinhados. A cor da moldura no Windows 11 acompanha o cabeçalho, e o espaçamento se adapta à largura da janela.
