...
**Latest version: [1.2.8](https://github.com/CarlosPlacinta/Pixelio/releases/tag/v1.2.8)** · **[Full changelog](CHANGELOG.md)**

## Install

Download **Pixelio-Setup-1.2.8-x64.exe** from the
...
Existing versions with the updater can receive 1.2.8 when they next open.
...
**Versão atual: [1.2.8](https://github.com/CarlosPlacinta/Pixelio/releases/tag/v1.2.8)** · **[Histórico completo](CHANGELOG.md)**

Baixe **Pixelio-Setup-1.2.8-x64.exe** na
...
A versão 1.2.8 inclui instalador Windows, avisos de atualização ao abrir e a cada
